          <section class="vbox">
            <div class="drawer drawer-right">
              <header role="banner">
                ...
                <div class="drawer-main drawer-default">
                  <nav class="drawer-nav" role="navigation">
                    <ul class="drawer-menu">
					  ...
					  <button class="btn btn-link btn-lg" data-toggle="collapse" data-target="#mapitem" style="text-align: left;color:white">Map Item Selector</button>
                        <div id="mapitem" class="collapse">
							<ul class="drawer-submenu">
							  <li class="drawer-submenu-item"><input type="checkbox" name="report" id="report" onclick="onclick_report()" > Tags/Reports</li>
							  <li class="drawer-submenu-item"><input type="checkbox" name="semuter" id="semuter" onclick="onclick_user()"> Semut Member</li>
							  <li class="drawer-submenu-item"><input type="checkbox" name="commuter" id="commuter" onclick="onclick_stops()" > Commuter Train</li>
							  <? if (!$this->session->userdata('logged_in')) { ?>
							  <li class="drawer-submenu-item"><input type="checkbox" name="cctv" id="cctv" onclick="onclick_cctv()" checked="true" > Cameras</li>
							  
							  <? } else { ?>
							 <!-- <li class="drawer-submenu-item"><input type="checkbox" name="parkingplace" id="parkingplace" onclick="click_place_parking()" > Parking Areas</li>-->
							  <li class="drawer-submenu-item"><input type="checkbox" name="friends" id="friends" onclick="onclick_friends()" > Friends</li>
							  <li class="drawer-submenu-item"><input type="checkbox" name="cctv_v" id="cctv_v" onclick="onclick_cctv_video()" > Cameras</li>
							  <?}?>
							</ul>
						</div>
                        <br>
						<button class="btn btn-link btn-lg" data-toggle="collapse" data-target="#placesitem" style="text-align: left;color:white">Places Item Selector</button>
						   <div id="placesitem" class="collapse">
							   <ul class="drawer-submenu">
								  ...
								  <li class="drawer-submenu-item"><input type="checkbox" name="univplace" id="univplace" onclick="click_place_univ()"> University</li>
									<li class="drawer-submenu-item"><input type="checkbox" name="gpstracersplaces" id="gpstracersplaces" onclick="click_place_tracer()"> GPS Tracer</li>
									<li class="drawer-submenu-item"><input type="checkbox" name="angkotplace" class="angkotplace" onclick="click_place_angkot(26)"> Show Angkot</li>

								</ul>
						   </div>
                        <br>
						<button class="btn btn-link btn-lg" data-toggle="collapse" data-target="#citiesitem" style="text-align: left;color:white">Cities Selector</button>
						   <div id="citiesitem" class="collapse">
								<ul class="drawer-submenu">
								  <li class="drawer-submenu-item"><button class="btn btn-link btn-sm" style="text-align: left;color:white" name="bandarlampung" id="bandarlampung" onclick="click_place_zoom(-5.396832, 105.266112)">Bandar Lampung</li>
								  <li class="drawer-submenu-item"><button class="btn btn-link btn-sm" style="text-align: left;color:white" name="bandung" id="bandung" onclick="click_place_zoom(-6.9268,107.6035)">Bandung</li>
								</ul>
						   </div>
                        <br>
				...
				<img src="http://bsts.lskk.ee.itb.ac.id/asset/images/logo/pptikitb.jpg" class="img-rounded" alt="Cinque Terre" width="75" height="50">&nbsp&nbsp
				<img src="http://bsts.lskk.ee.itb.ac.id/asset/images/logo/logolampung.jpg" class="img-rounded" alt="Cinque Terre" width="50" height="75">&nbsp&nbsp
				<img src="http://bsts.lskk.ee.itb.ac.id/asset/images/logo/ubllogo.jpg" class="img-rounded" alt="Cinque Terre" width="75" height="50"> &nbsp&nbsp
				</div>-->
              </header>
...
function closePopup(id){
  ...
  var map = L.map('peta').setView([-6.9268,107.6035], 5);
...
function click_place_tracer2() {
    gpstracersLayer.clearLayers();
    $.get('<?=base_url('maps/get_gpstracer')?>', function(gpstr) {
        gpstr = $.parseJSON(gpstr);
        if($('#gpstracersplaces').is(":checked")){
            for(i=0;i<gpstr.length;i++){
                gpstracersmarker = new L.marker([gpstr[i].Latitude,gpstr[i].Longitude], {icon: gpstrackerIcon});
