...
$config['mongo_db']['default']['hostname'] = '167.205.7.226';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'semut';
$config['mongo_db']['default']['password'] = 'Semut123';
$config['mongo_db']['default']['database'] = 'bsts_new';
