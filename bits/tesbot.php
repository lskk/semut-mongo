              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="gallery.html">OF</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
            ...
            <h3>Place Item</h3>
                    ...
                    <div class="desc">
                     ...
                     <div class="desc">
                        ...
                        <div class="details">
                          <input type="checkbox" class='hospital'>Hospital</input>
                        </div>
                      </div>
                       ...
                       <div class="desc">
                        ...
                        <div class="details">
                          <input type="checkbox" class='bus'>Bus Station</input>
                        </div>
                      </div>
